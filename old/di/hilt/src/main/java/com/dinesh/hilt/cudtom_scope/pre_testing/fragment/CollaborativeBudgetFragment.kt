...
//
//@AndroidEntryPoint
//class CollaborativeBudgetFragment: Fragment() {
//    private val TAG = "log_" + CollaborativeBudgetFragment::class.java.name.split(CollaborativeBudgetFragment::class.java.name.split(".").toTypedArray()[2] + ".").toTypedArray()[1]
//
